...
int create(char *issuer, int max_supply, char *token_id){
    ...
    ABA_createToken(token_id, strlen(token_id), max_supply, 0, issuer, strlen(issuer));
...
int issue(char *to, int amount, char *token_id){
    ...
    ABA_issueToken(to, strlen(to), amount, token_id, strlen(token_id));
...
int transfer(char *from, char *to, int amount, char *token_id){
    ...
    ABA_transfer(from, strlen(from), to, strlen(to), amount, token_id, strlen(token_id), "active", strlen("active"));
