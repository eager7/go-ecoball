...
func TestNode1(t *testing.T) {
	...
	{
		m := example.Message(fmt.Sprintf("node1111111111:%d", 9001))
		CheckErrorPanic(n.SendMessage(pubKey2, "127.0.0.1", "9014", &m))
	}
	utils.Pause()
}
...
func TestNode2(t *testing.T) {
	...
	{
		m := example.Message(fmt.Sprintf("node1111111111:%d", 9012))
		CheckErrorPanic(n.SendMessage(pubKey1, "127.0.0.1", "9012", &m))
	}
	utils.Pause()
}
