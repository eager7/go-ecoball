...
var (
	rpcLog     elog.Logger   = elog.NewLogger("http", elog.NoticeLog)
	httpServer HttpRpcServer = HttpRpcServer{method2Handle: make(map[string]func([]interface{}) *common.Response)}
)
